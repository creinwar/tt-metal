...
from models.demos.utils.llm_demo_utils import create_benchmark_data, verify_perf, verify_tokens
...
def run_falcon_demo_kv(
    ...
    if expected_perf_metrics is not None:
        ...
        verify_tokens(generated_text, expected_greedy_output_path)
