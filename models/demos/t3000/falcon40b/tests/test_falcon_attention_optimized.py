...
from models.demos.t3000.falcon40b.tt.falcon_attention_optimized import TtFalconAttentionOptimized
...
def run_test_FalconAttention_inference(
    ...
    tt_FalconAttention_model = TtFalconAttentionOptimized(
        device_mesh,
        state_dict,
        base_url,
        layer_num,
    ...
    if llm_mode == "decode":
        tt_out_tensor = tt_out_tensor.transpose(0, 1)
    tt_layer_present = (
        torch.repeat_interleave(
