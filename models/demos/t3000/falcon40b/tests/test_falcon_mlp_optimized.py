...
from models.demos.t3000.falcon40b.tt.falcon_mlp_optimized import TtFalconMLPOptimized
...
def run_test_FalconMLP_inference(
    ...
    tt_FalconMLP_model = TtFalconMLPOptimized(
        # devices,
        device_mesh,
        state_dict,
        base_url,
...
def test_FalconMLP_inference(
    ...
    print(t3k_device_mesh.get_device_ids())
