...
def test_fadnetpp_model(device, reset_seeds, model_location_generator):
    ...
    img_left = Image.open("models/experimental/functional_fadnetpp/demo/image1.png")
    img_right = Image.open("models/experimental/functional_fadnetpp/demo/image2.png")
