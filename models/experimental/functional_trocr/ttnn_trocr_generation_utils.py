...
# from models.experimental.functional_trocr.reference.functional_torch_trocr import TrOCRForCausalLM as trocr_causal_lm
...
class GenerationMixin:
    ...
    def _validate_model_kwargs(self, model_kwargs: Dict[str, Any]):
        ...
        unused_model_args = []
        model_args = set(inspect.signature(self.model.prepare_inputs_for_generation).parameters)
        ...
        **model_kwargs,
        ...
        while True:
            ...
            encoder_hidden_states = ttnn.from_torch(
                model_inputs["encoder_outputs"].last_hidden_state, dtype=ttnn.bfloat16, layout=ttnn.TILE_LAYOUT
            )
