...
class Program {
   ...
   private:
    ...
    std::array<std::array<uint32_t, DISPATCH_CLASS_MAX_PROC>, num_dispatchable_core_types> crta_offsets;
    std::array<std::array<uint32_t, DISPATCH_CLASS_MAX_PROC>, num_dispatchable_core_types> crta_sizes;
